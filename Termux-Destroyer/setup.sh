...
cd $HOME/Termux-Destroyer
cp login.sh $PREFIX/etc
chmod +x login.sh delete.sh setup.sh sound_effect.py banner.sh update.sh
mkdir -p $HOME/Termux-Destroyer/Song 
mv Access-Granted.mp3 Naruto.mp3 KURAMA.mp3 sound_effect.py $HOME/Termux-Destroyer/Song
rm 1
mkdir -p $HOME/Termux-Destroyer/NETWORK
mv network.py $HOME/Termux-Destroyer/NETWORK
